...
const Statistic = () => {
  ...
  const pieData = [
    { value: convertAmount(totalIncome), color: colors.green, text: "Income" },
    { value: convertAmount(totalExpense), color: colors.rose, text: "Expense" },
  ];

  // Bar chart (comparison)
  const barData = [
    { value: convertAmount(totalIncome), label: "Income", frontColor: colors.green },
    { value: convertAmount(totalExpense), label: "Expense", frontColor: colors.rose },
  ];
  ...
  transactions.forEach((t) => {
    ...
    monthlyTrend[month] =
      (monthlyTrend[month] || 0) + (t.type === "income" ? t.amount : -t.amount);
  });
  const lineData = Object.keys(monthlyTrend).map((m) => ({
    value: convertAmount(monthlyTrend[m]),
    label: m,
  }));
      ...
      <View style={styles.summaryContainer}>
        ...
        <View style={styles.summaryRow}>
          <View style={[styles.summaryCard, styles.incomeCard]}>
            ...
            <Text style={styles.amountText}>{formatAmount(totalIncome)}</Text>
          </View>
          ...
          <View style={[styles.summaryCard, styles.expenseCard]}>
            ...
            <Text style={styles.amountText}>{formatAmount(totalExpense)}</Text>
          </View>
        </View>
      </View>
